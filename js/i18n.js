const TRANSLATIONS = {
  id: {
    ...
    "settings-opt-1s": "Sangat Cepat / Default (1 Detik)",
    ...
    "dt-dp": "Uang Muka (DP)",
    "dt-settlement": "Pelunasan",
    "dt-debt": "Sisa Pelunasan",
    "dt-payment-method": "Metode Pembayaran",
    ...
    "add-btn-7days": "+1 Minggu",
    "add-btn-14days": "+2 Minggu",
    "add-btn-30days": "+1 Bulan",
    "add-deadline-warning": "Peringatan: Deadline sangat mepet!",
    ...
    "rep-desc": "Rekap projek, pendapatan kotor (omzet), pelunasan, pengeluaran, dan laba rugi.",
    ...
    "rep-card2-title": "Pelunasan & DP",
    "rep-card2-sub1": "DP Diterima",
    "rep-card2-sub2": "Sisa Pelunasan",
  ...
  en: {
    ...
    "settings-opt-1s": "Very Fast / Default (1 Second)",
    ...
    "dt-settlement": "Settlement",
    "dt-debt": "Remaining Balance",
    "dt-payment-method": "Payment Method",
    ...
    "add-btn-7days": "+1 Week",
    "add-btn-14days": "+2 Weeks",
    "add-btn-30days": "+1 Month",
    "add-deadline-warning": "Warning: Deadline is very close!",
    ...
    "rep-desc": "Recap of projects, gross income (revenue), settlements, expenses, and net profit.",
    ...
    "rep-card2-title": "Settlement & Down Payment",
    "rep-card2-sub1": "DP Received",
    "rep-card2-sub2": "Remaining Settlement",
